...
public class Util
{
    ...
    {
        double out = _in;
        if (out < _lowerLimit) out = _lowerLimit;
        if (out > _upperLimit) out = _upperLimit;
        return out;
    }
    ...
    public static Optional<Vector2d[]> getLineCircleIntersection(Vector2d _p1, Vector2d _p2, Vector2d _center,
            double _radius)
    {
