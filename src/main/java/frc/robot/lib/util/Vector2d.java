...
public class Vector2d implements Interpolable<Vector2d>
{
	...
	/*
	 * perform exponential filtering on position alpha is the filtering coefficient,
	 * 0<alpha<<1 result will converge 63% in 1/alpha timesteps 86% in 2/alpha
	 * timesteps 95% in 3/alpha timesteps
	 */
