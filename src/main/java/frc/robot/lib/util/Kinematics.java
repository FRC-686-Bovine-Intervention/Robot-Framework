...
import frc.robot.subsystems.TestDriveLoop;
...
public class Kinematics 
{
    ...
    public static LinearAngularSpeed forwardKinematics(double _lSpeed, double _rSpeed)
    {
    	...
    	double angularSpeed = dSpeed * 2 * TestDriveLoop.kTrackScrubFactor / TestDriveLoop.kTrackEffectiveDiameter;		// angular velocity (in rad/sec) due to differential speed
    ...
    {
        double dSpeed = _angularSpeed * TestDriveLoop.kTrackEffectiveDiameter / (2 * TestDriveLoop.kTrackScrubFactor);
