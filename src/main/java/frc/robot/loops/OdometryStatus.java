...
import frc.robot.subsystems.StatusBase;
...
{
    // singleton class
    private static OdometryStatus instance = null;

    public static OdometryStatus getInstance()
    {
        if (instance == null)
        {
            instance = new OdometryStatus();
        }
        return instance;
    }
    ...
    public OdometryStatus setReal(boolean isReal)
    {
        this.isReal = isReal;
        return this;
    }
    ...
    // {
    //     synchronized (OdometryStatus.this)
    //     {
