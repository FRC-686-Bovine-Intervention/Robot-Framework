...
public class Constants extends ConstantsBase
{
    ...
    // Vision constants
    public static double kCameraPoseX = 0.0; // camera location with respect to robot center of rotation, +X axis is in
                                             // direction of travel
    public static double kCameraPoseY = 0.0; // camera location with respect to robot center of rotation, +Y axis is
    ...
    public static double kPegTargetDistanceThresholdFromBumperInches = 18; // inches to stop from target, measured from
                                                                           // front bumper
    public static double kPegTargetDistanceThresholdFromCameraInches = kCenterToFrontBumper - kCameraPoseX
            + kPegTargetDistanceThresholdFromBumperInches;
