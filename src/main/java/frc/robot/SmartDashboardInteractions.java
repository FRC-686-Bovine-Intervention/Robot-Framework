...
public class SmartDashboardInteractions
{
    ...
    {
        LEFT_START("Left", FieldDimensions.getLeftStartPose()), CENTER_START("Center",
                FieldDimensions.getCenterStartPose()), RIGHT_START("Right", FieldDimensions.getRightStartPose());
    ...
    {
        DELAY_0_SEC("0 Sec", 0.0), DELAY_1_SEC("1 Sec", 1.0), DELAY_2_SEC("2 Sec", 2.0), DELAY_3_SEC("3 Sec",
                3.0), DELAY_4_SEC("4 Sec", 4.0), DELAY_5_SEC("5 Sec", 5.0);
    ...
    enum JoystickOption
    {
        ARCADE_DRIVE("Arcade Drive"), TRIGGER_DRIVE("Trigger Drive"), // works for Xbox controller and Xbox steering
                                                                      // wheel
        TANK_DRIVE("Tank Drive"), CHEESY_ARCADE_DRIVE("Cheesy Arcade Drive"), CHEESY_TRIGGER_DRIVE(
                "Cheesy Trigger Drive"), CHEESY_2STICK_DRIVE("Cheesy Two-Stick Drive");
        public final String name;
