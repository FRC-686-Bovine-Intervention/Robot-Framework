...
public class SquarePatternMode extends AutoModeBase
{
    ...
    private void init()
    {
        ...
        PathSegment.Options options = new PathSegment.Options(DriveLoop.kPathFollowingMaxVel,
                DriveLoop.kPathFollowingMaxAccel, DriveLoop.kPathFollowingLookahead, false);
