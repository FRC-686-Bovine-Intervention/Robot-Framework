 ...
 * 
 * The entire set of actions will be declared done if 1: the entire list of
 * actions report done 2: any of the interrupting actions report done
 * 
 * @param A
...
public class InterruptableAction implements Action
{
    ...
    public boolean isFinished()
    {
        ...
        if (finished) System.out.println("InterruptableAction Finished");
