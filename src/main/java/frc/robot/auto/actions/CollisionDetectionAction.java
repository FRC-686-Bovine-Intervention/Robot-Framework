...
/**
 * Action for detecting a collision using NavX gyro.
 */
public class CollisionDetectionAction implements Action
{
    ...
    public static double kCollisionJerkThreshold = 0.9; // maximum JerkY was 0.9 for a 24 inch/sec collision into wall
                                                        // (<0.1 when driving normal)
    ...
    public CollisionDetectionAction()
    {
        ...
        // TODO: error if NavX isn't installed
    }
    ...
    public String toString()
    {
        return String.format(
                "Collision Detection -- JerkX: % 5.3f, JerkY: % 5.3f, JerkThresh: %4.1f, lMotorCurrent: % 5.3f, rMotorCurrent: % 5.3f, CurrentThresh: %4.1f, ",
                jerkX, jerkY, kCollisionJerkThreshold, lMotorCurrent, rMotorCurrent, kCollisionCurrentThreshold);
    }
